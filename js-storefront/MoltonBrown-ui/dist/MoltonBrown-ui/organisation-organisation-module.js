...
var OrganisationComponent = /** @class */ (function () {
    function OrganisationComponent(location, orgServ, singletonServ, deviceService, router, route, titleService, metaService) {
    ...
    OrganisationComponent.prototype.getContent = function () {
        var _this = this;
        var that = this;
        ...
        this.route.params.subscribe(function (params) {
            for (var _i = 0, _catData_1 = _catData; _i < _catData_1.length; _i++) {
                ...
                var result = that.dfs(obj, params.sitename);
                if (result) {
    ...
    OrganisationComponent.prototype.getDeviceInfo = function () {
    ...
    OrganisationComponent.prototype.dfs = function (obj, targetId) {
        ...
        if (obj.children) {
            for (var _i = 0, _a = obj.children; _i < _a.length; _i++) {
                var item = _a[_i];
                var check = this.dfs(item, targetId);
                if (check) {
                    return check;
                }
            }
    ...
    OrganisationComponent.prototype.renderTemplate = function (data) {
        var that = this;
        var content = data;
    ...
    OrganisationComponent.prototype.getRouterMenuPath = function (data) {
        if (!this.mobileDevice) {
            if (!data.header) {
                if (data.route == "store/company/stores") {
                    ...
                    var _url = "/store/" + data.filterBy;
                    return _url;
                }
            }
        }
    };
    OrganisationComponent.prototype.onMenuContentClick = function (data, k) {
        if (!this.mobileDevice) {
            if (!data.header) {
                if (data.route == "store/company/stores") {
                    var route = data.route.split('/');
    ...
    OrganisationComponent.prototype.getRouterPath = function (data) {
        if (data.filterBy == "careers/faqs") {
            var url = 'http://www.kaocareers.com/';
        }
        else {
            var _url = "/store/" + data.filterBy;
            return _url;
    ...
    OrganisationComponent.prototype.onSubMenuContentClick = function (event, data) {
    ...
    OrganisationComponent.prototype.onCollapseMenu = function () {
        if (this.orgMenu) {
            this.orgMenu = false;
        }
        else {
    ...
    OrganisationComponent.prototype.getStaticCntnt = function (lang) {
        var _this = this;
        this.orgServ.getStaticContent(lang).subscribe(function (response) {
            _this.searchByData = response['organisation'];
            _this.getContent();
        });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("orgnaisationEl"),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], OrganisationComponent.prototype, "orgnaisationEl", void 0);
    OrganisationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./organisation.component.scss */ "./src/app/organisation/organisation.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"],
            _organisation_service__WEBPACK_IMPORTED_MODULE_7__["OrganisationComponentService"],
...
/*!*****************************************************!*\
  !*** ./src/app/organisation/organisation.module.ts ***!
  \*****************************************************/
/*! exports provided: OrgainisationRouteModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrgainisationRouteModule", function() { return OrgainisationRouteModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _organisation_organisation_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../organisation/organisation.component */ "./src/app/organisation/organisation.component.ts");
/* harmony import */ var _organisation_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./organisation.service */ "./src/app/organisation/organisation.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: _organisation_organisation_component__WEBPACK_IMPORTED_MODULE_7__["OrganisationComponent"], runGuardsAndResolvers: 'always' }
];
var OrgainisationRouteModule = /** @class */ (function () {
    function OrgainisationRouteModule() {
    }
    OrgainisationRouteModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _organisation_organisation_component__WEBPACK_IMPORTED_MODULE_7__["OrganisationComponent"]
            ],
            providers: [
                _organisation_service__WEBPACK_IMPORTED_MODULE_8__["OrganisationComponentService"]
            ]
        })
    ], OrgainisationRouteModule);
    return OrgainisationRouteModule;
}());
...
/*!******************************************************!*\
  !*** ./src/app/organisation/organisation.service.ts ***!
  \******************************************************/
/*! exports provided: OrganisationComponentService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrganisationComponentService", function() { return OrganisationComponentService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var OrganisationComponentService = /** @class */ (function (_super) {
    __extends(OrganisationComponentService, _super);
    function OrganisationComponentService(http) {
    ...
    OrganisationComponentService.prototype.getStaticContent = function (lang) {
    ...
    OrganisationComponentService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({ providedIn: 'root' }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], OrganisationComponentService);
    return OrganisationComponentService;
