...
export const environment :{
  ...
  AUTHRISATION_PATH:'https://api.cxur-kaocorpor1-d4-public.model-t.cc.commerce.ondemand.com/authorizationserver/',
  CS_AUTHRISATION_PATH:'https://api.cxur-kaocorpor1-d4-public.model-t.cc.commerce.ondemand.com/authorizationserver/',
  CS_CUSTOMER:'https://api.cxur-kaocorpor1-d4-public.model-t.cc.commerce.ondemand.com/',
  API_PATH:function(){
    const path='https://api.cxur-kaocorpor1-d4-public.model-t.cc.commerce.ondemand.com/kaowebservices/v2/';
 ...
 countryJsonData:[
  ...
  },
  {
    ...
    query:"https://jsapps.cxur-kaocorpor1-d4-public.model-t.cc.commerce.ondemand.com/store/index?country_store=us"
  },
  {
    countryCode: "eu",
    ...
    query:"https://jsapps.cxur-kaocorpor1-d4-public.model-t.cc.commerce.ondemand.com/store/index?country_store=eu"
  },
  {
    countryCode: "de",
    countryImg: "assets/imgs/icon_country_german.gif",
    ...
    query:"https://jsapps.cxur-kaocorpor1-d4-public.model-t.cc.commerce.ondemand.com/store/index?country_store=de"
  },
  {
    countryCode: "jp",
